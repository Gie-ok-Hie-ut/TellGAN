...
python train_optflow_lstm.py --train --continue --ep-start 0 --vid-start 640 --dataroot /home/jake/classes/cs703/Project/data/grid/ --ckptdir ./optflowGAN_chkpnts --features-model /home/jake/classes/cs703/Project/dev/TellGAN/src/assests/predictors/shape_predictor_68_face_landmarks.dat
